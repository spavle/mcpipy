...
def testKomplet(orMj, orSm, iX=0, iZ=0, iY=0, materijal=98, dv=0, stepenice_mat=109):
    ...
    for br in range(0, 8):
        crtaj_stepenice(orMj, (11 + br, -1, -1 - br), (11 + br, 1, -1 - br), orSm, blok_id=109, rel_smjer="odmene",
                        gore_dolje="ne")
    ...
    for br in range(0, 5):
        crtaj_stepenice(orMj, (5, -19 + br, 4 - br), (5, -19 + br, 4 - br), orSm, blok_id=109, rel_smjer="desno",
                        gore_dolje="ne")
