...
def mali(orMj, orSm, iX=0, iZ=0, iY=0):
    ...
    crtaj_stepenice(orMj, [0, 0, 3], [0, 0, 3], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="da")  # gore stepenica
    crtaj_stepenice(orMj, [0, 0, 1], [0, 0, 1], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # dolje stepenica
...
def kuca_09(orMj, orSm, iX=0, iZ=0, iY=0):
    ...
    crtaj_stepenice(orMj, (10, 0, 8), (10, 0, 8), orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # ukras na krovu
    # police unutra
    for dX in (5, 8):
...
def kuca_08(orMj, orSm, iX=0, iZ=0, iY=0):
    ...
    # desni podest
    crtaj_stepenice(orMj, [-1, 6, 0], [-4, 6, 0], orSm, blok_id=53, rel_smjer="desno",
                    gore_dolje="da")  # stepenice desno na kraju
    ...
    crtaj_stepenice(orMj, [-5, 5, 0], [-5, 5, 0], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # prednja stepenica
    ...
    crtaj_stepenice(orMj, [-4, 2, 1], [-4, 2, 1], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # dolje stepenica
    ortPom = ortUdesno(orSm)
    ...
    crtaj_stepenice(orMj, [4, 2, 1], [4, 2, 1], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # dolje stepenica
    ...
    # lijevi podest
    crtaj_stepenice(orMj, [-3, 0, 0], [-3, -7, 0], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="da")  # stepenice lijevo napred
    ...
    crtaj_stepenice(orMj, [-3, -7, 0], [4, -7, 0], orSm, blok_id=53, rel_smjer="lijevo",
                    gore_dolje="da")  # stepenice lijevo lijevo
    ...
    crtaj_stepenice(orMj, (-5, 2, 5), (-5, 2, 5), orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # ukras na chepu
    ...
    crtaj_stepenice(orMj, [0, -3, 1], [0, -2, 1], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # dolje stepenice
    # prednji krov
    ...
    crtaj_stepenice(orMj, [1, -6, 5], [1, 7, 5], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # zajednicki krov lijeve i desne sobe
    ...
    crtaj_stepenice(orMj, [2, -6, 6], [2, -6, 6], orSm, blok_id=53, rel_smjer="desno",
                    gore_dolje="ne")  # ukras na deblu lijevo
    crtaj_stepenice(orMj, [2, 7, 6], [2, 7, 6], orSm, blok_id=53, rel_smjer="lijevo",
                    gore_dolje="ne")  # ukras na deblu desno
    crtaj_stepenice(orMj, [3, -6, 5], [3, 7, 5], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # zajednicki krov lijeve i desne nazad
    crtaj_stepenice(orMj, [4, -6, 4], [4, 7, 4], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # zajednicki krov lijeve i desne nazad
    ...
    for br in range(0, 4):
        crtaj_stepenice(orMj, (5 + br, 0, 3 - br), (5 + br, -6, 3 - br), orSm, blok_id=53, rel_smjer="odmene",
                        gore_dolje="ne")
    ...
    crtaj_stepenice(orMj, [-2, -1, 1], [-2, -1, 1], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # zid prema meni
    crtaj_kvadar(orMj, [-2, -1, 2], [-2, -1, 2], orSm, 102, blok_dv=0)  # prozor
    crtaj_stepenice(orMj, [2, 1, 1], [2, 1, 1], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # zadnji zid  desno
    crtaj_kvadar(orMj, [2, 1, 2], [2, 1, 2], orSm, 102, blok_dv=0)  # prozor
    crtaj_stepenice(orMj, [2, -1, 1], [2, -1, 1], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # zadnji zid lijevo
    crtaj_kvadar(orMj, [2, -1, 2], [2, -1, 2], orSm, 102, blok_dv=0)  # prozor
    ...
    crtaj_stepenice(orMj, [-2, -1, 3], [-2, -1, 3], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="da")  # zid prema meni
    crtaj_stepenice(orMj, [2, 1, 3], [2, 1, 3], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="da")  # zadnji zid  desno
    crtaj_stepenice(orMj, [2, -1, 3], [2, -1, 3], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="da")  # zadnji zid lijevo
    crtaj_stepenice(orMj, [0, 3, 3], [0, 3, 3], orSm, blok_id=53, rel_smjer="desno", gore_dolje="da")  # zid  desno
    crtaj_stepenice(orMj, [0, -3, 3], [0, -3, 3], orSm, blok_id=53, rel_smjer="lijevo",
                    gore_dolje="da")  # zid lijevo
    ...
    # krov
    crtaj_stepenice(orMj, [-2, -4, 3], [-2, 4, 3], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # krov prema meni
    crtaj_stepenice(orMj, [2, -4, 3], [2, 4, 3], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # krov prema meni
    crtaj_stepenice(orMj, [-1, -4, 4], [-1, 4, 4], orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # krov prema meni
    crtaj_stepenice(orMj, [1, -4, 4], [1, 4, 4], orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # krov prema meni
    ...
    crtaj_stepenice(orMj, (-4, 1, 0), (-4, 1, 0), orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="ne")  # stepenica za ulazak na podest

    crtaj_kvadar(orMj, (-4, -4, 0), (-4, -4, 0), orSm, 5, 0)  # lijevo kocka
    crtaj_stepenice(orMj, (-3, -4, 0), (-2, -4, 0), orSm, blok_id=53, rel_smjer="lijevo",
                    gore_dolje="da")  # stepenica za ulazak na podest
    crtaj_stepenice(orMj, (-3, 3, 0), (-3, 4, 0), orSm, blok_id=53, rel_smjer="odmene",
                    gore_dolje="ne")  # stepenica silazak sa podesta
    crtaj_stepenice(orMj, (-4, 3, 0), (-4, 3, 0), orSm, blok_id=53, rel_smjer="meni",
                    gore_dolje="da")  # stepenica naopako pored ulaza HACK - zadnje
