...
def glassFarm ( orMj , orSm , iX=0 , iZ=0 , iY=0 ):
   ...
   #ograda okolo
   crtaj_kvadar ( orMj , (  0 , -19 ,  1)  , (  29 , 19 ,  1 ) , orSm ,  85 , 0 )
   #prvo zrak iznad
   crtaj_kvadar ( orMj , (  1 , -18 ,  1)  , (  28 , 18 , 1 ) , orSm ,  0 , 0 )
   #pa dolje farmland
   crtaj_kvadar ( orMj , (  1 , -18 ,  0)  , (  28 , 18 ,  0 ) , orSm ,  60 , 0 )
   #hopperi
   for dY in ( -9 , -5 , 5 , 9 ):
      crtaj_hopper    ( orMj , (  28 , dY , 0 )  , (  0 , dY ,  0  ) , orSm ,  "meni"  )
   #stakleni hodnici
   for dZ in ( -7 , 7 ):
      crtaj_kvadar ( orMj , (  0 , dZ+1 , 0 )  , (  29 , dZ-1 , 0 ) , orSm ,  89 , 0 )   # svjetlaca podloga, anti monster
      crtaj_kvadar ( orMj , (  0 , dZ+1 , 1 )  , (  29 , dZ-1 , 3 ) , orSm ,  20 , 0 )   # zidovi
      for dX in ( 1 , 8 , 15 , 22 ):
         crtaj_kvadar ( orMj , (  dX , dZ , 1 )  , (  dX + 5 , dZ , 3 ) , orSm ,  0 , 0 )   # zrak, voda za probu
   #biljke
   for urod in ((59,-14),(141,0),(142,14)): # svaka u svom polju
      crtaj_kvadar ( orMj , (  1 , urod [ 1 ] + 4 , 1)  , (  28 , urod [ 1 ] - 4 , 1 ) , orSm ,  urod [ 0 ] , 7 )
      #vrtlari
      gdje2 = rel2abs ( orMj , (  4 , urod [ 1 ] , 1 )   , orSm  )
      id = mc.spawnEntity('Villager',  int (gdje2 [0])  ,int (gdje2 [1]) ,int (gdje2 [2]) , "{Profession:0,Career:2,}" )
   #voda 
   for dX in ( 6 , 15 , 24 ):
      for dZ in ( -14 , 0 , 14 ):
         crtaj_kvadar ( orMj , (  dX , dZ , -1 )  , (  dX , dZ , -1 ) , orSm ,  0 , 0 )   # ispod vode lampa
         crtaj_kvadar ( orMj , (  dX , dZ , 0 )  , (  dX , dZ , 0 ) , orSm ,  9 , 0 )   # voda
         crtaj_kvadar ( orMj , (  dX , dZ , 1 )  , (  dX , dZ , 1 ) , orSm ,  89 , 0 )   # iznad glowstone , anti monster      
...
if __name__ == "__main__":    #direktan poziv
   ...
   glassFarm (  orMj , orSm , iX=0 , iZ=0 , iY=0  ) #wheat
