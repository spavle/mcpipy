...
def glassCowFarm (  orMj ,  orSm , iX=0 , iZ=0 , iY=0 ):
   ...
   crtaj_kvadar ( orMj , ( 1 , -1 , -1 )  , ( 6 , 1 , -1  ) , orSm , 98 , 0 ) #temelji od stomebricks
   crtaj_kvadar ( orMj , ( 1 , -1 , 0 )  , ( 6 , 1 , 4  ) , orSm , 20 , 0 ) #gore staklo
   crtaj_hopper    ( orMj , ( 1 , 0 , -1 )  , ( 5 , 0 , -1 ) , orSm ,  rel_smjer = "meni" )  # u sredini hopperi prema meni
   crtaj_kvadar ( orMj , ( 2 , -1 , 0 )  , ( 5 , -1 , 0  ) , orSm , 98 , 0 )# po lijevoj strani podloga za droppere i nosaci za trapdoor
   for br in range ( 2 , 6 ):
      crtaj_klopku   ( orMj , ( br , 0 , 0 )   , orSm , rel_smjer = "lijevo" , stanje="zatvoreno" , visina = "dolje" )
   ...
   """
   crtaj_kvadar ( orMj , ( 2 , 0 , 1 )  , ( 5 , 0 , 1  ) , orSm , 0 , 0 ) # doljnja rupa u ravnini droppera
   crtaj_kvadar ( orMj , ( 2 , 0 , 3 )  , ( 5 , 0 , 4  ) , orSm , 0 , 0 ) # gornja  rupa u ravnini droppera
   crtaj_kvadar ( orMj , ( 5 , 0 , 2 )  , ( 5 , 0 , 2  ) , orSm , 0 , 0 ) # spoj gore dolje
   crtaj_kvadar ( orMj , ( 5 , 0 , 4 )  , ( 5 , 0 , 4  ) , orSm , 44 , 5 ) # halfslabb
   for br in ( 2 , 3 , 4 ):
      crtaj_button ( orMj , ( br , -2 , 0 )  , ( br , -2 , 0  ) , orSm ,  rel_smjer = "lijevo" )
     
   bla = rel2abs ( orMj , ( 3 , -1 , 3  ) , orSm )
   time.sleep ( 10 )
   for jao in range ( 1, 4 ):
